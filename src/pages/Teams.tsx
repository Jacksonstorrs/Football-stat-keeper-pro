...
import { UserPlus, Trash2, Save, ArrowLeft, Shield, Users } from "lucide-react";
          ...
          <Card className="p-6 space-y-6 border-none shadow-lg">
            <div className="flex items-center gap-3 pb-4 border-b">
              <div className="w-10 h-10 rounded-xl bg-red-600 flex items-center justify-center text-white">
                <Shield className="w-6<dyad-write path="src/pages/Teams.tsx" description="Completing the team management page with full roster and team settings functionality.">
"use client";
