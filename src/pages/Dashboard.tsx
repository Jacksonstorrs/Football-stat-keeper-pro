      ...
      <main className="max-w-6xl mx-auto p-6 md:p-12">
        <div className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6">
          ...
          <div className="flex gap-3">
            <Button variant="outline" onClick={handleCopyLink} className="h-14 px-6 font-black uppercase tracking-widest gap-2 border-slate-200 dark:border-white/10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <Card className="lg:col-span-2 p-8 bg-white dark:bg-slate-900 border-none shadow-sm">
            <div className="flex items-center justify-between mb-8">
              ...
              <Link to="/games">
                <Button variant="ghost" size="sm" className="text-[10px] font-black uppercase tracking-widest text-slate-400 hover:text-slate-900 dark:hover:text-white">
                  View History
                </Button>
              </Link>
            </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="pt-6 border-t border-white/10">
                    ...
                    <div className="h-1.5 w-full bg-white/5 rounded-full overflow-hidden">
                      <div className="h-full bg-blue-500 rounded-full transition-all duration-1000" style={{ width: `${Math.min(100, (stats.gamesPlayed / 12) * 100)}%` }} />
                    </div>
                  </div>
                </div>
              </div>
